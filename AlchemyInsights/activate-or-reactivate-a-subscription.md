...
3. Selecione **Mais ações** (três pontos) e, em seguida, selecione **Reativar esta assinatura**.
    > [!IMPORTANT]
    > Se você não vir **Reativar essa** assinatura como uma ação disponível, [chame Suporte](/microsoft-365/admin/contact-support-for-business-products) para reativar sua assinatura.
