...
[Restaurar um site do OneDrive excluído](https://docs.microsoft.com/en-us/onedrive/restore-deleted-onedrive)

Para ações de lixeira em massa, os administradores podem considerar o uso de [PnP do SharePoint Online](https://docs.microsoft.com/en-us/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps).

## <a name="files-restore-feature"></a>Recurso de restauração de arquivos
