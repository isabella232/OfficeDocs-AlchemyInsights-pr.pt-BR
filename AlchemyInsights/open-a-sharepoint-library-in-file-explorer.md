...
ms.locfileid: "29457446"
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>Abrir uma biblioteca do SharePoint no Gerenciador de arquivos

1. Navegue até a biblioteca no Internet Explorer 10 ou 11 do Internet Explorer. 
    
2. Clique no ícone de exibição no canto superior direito e clique em **modo de exibição no Gerenciador de arquivos**.
