...
1. No centro de administração, acesse **produtos \> de cobrança [& serviços](https://go.microsoft.com/fwlink/p/?linkid=842054)**.

2. Selecione a assinatura que você deseja atualizar.

3. Na [página detalhes da assinatura](https://admin.microsoft.com/AdminPortal/Home#/subscriptions/webdirect%252F0dbaa202-d590-4529-98c2-a5e2ebaac702), selecione **atualização**.
