...
Para usar o Microsoft to-do, um administrador deve habilitar o aplicativo na conta de cada usuário. Vá até a [ &amp; página suplementos de serviços](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns) da página Configurações de administração do Microsoft 365 para habilitar a tarefa pendente para cada usuário.
 ...
 **Observação**: se você receber um erro 501 ao tentar fazer o login [https://todo.microsoft.com](https://todo.microsoft.com) , tente [https://to-do.microsoft.com](https://to-do.microsoft.com) .
