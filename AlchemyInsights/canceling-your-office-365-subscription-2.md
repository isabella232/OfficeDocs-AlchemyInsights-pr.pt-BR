...
Com base nos dados da sua organização, acreditamos que todas as suas assinaturas atuais têm mais de 25 licenças atribuídas. Você pode remover os usuários até menos de 25, ir para a página [assinaturas](https://go.microsoft.com/fwlink/p/?linkid=842054) ou ir para **assinaturas**de **cobrança** \> e, em seguida, escolher **mais ações** \> **cancelar assinatura**.
  
Como alternativa, use a opção "Deixe-nos ligar para você" para falar com um engenheiro de suporte.
