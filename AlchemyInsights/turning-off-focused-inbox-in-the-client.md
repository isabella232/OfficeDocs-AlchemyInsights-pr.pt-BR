...
Para desativar a caixa de entrada destaques para todos na organização, consulte [Configurar a caixa de entrada destaques para todos em sua organização](https://docs.microsoft.com/office365/admin/setup/configure-focused-inbox).
