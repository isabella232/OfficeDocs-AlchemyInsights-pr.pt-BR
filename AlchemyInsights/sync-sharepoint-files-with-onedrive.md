...
Se você optou por usar a Exibição do Explorer em vez de usar o novo cliente de sincronização, siga as etapas e as práticas recomendadas nos artigos abaixo.
...
Observação: O botão Abrir com o Explorer não aparece na nova experiência da biblioteca. Clique no menu suspenso Exibir no canto superior direito (o nome do menu suspenso varia dependendo da sua exibição atual), e clique em Exibir no Explorador de Arquivos.
