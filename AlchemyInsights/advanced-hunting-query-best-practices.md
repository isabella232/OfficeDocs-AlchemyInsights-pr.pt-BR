...
ms.locfileid: "57888998"
---
# <a name="advanced-hunting-query-best-practices"></a>Práticas recomendadas de consulta de busca avançada

Confira o artigo completo Práticas recomendadas de [consulta de busca avançada](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/advanced-hunting-best-practices#optimize-query-performance) para recomendações detalhadas e orientações sobre:
