...
para escolher como o Outlook.com responderá às solicitações de confirmação de leitura, vá para [configurações de tratamento de mensagens](https://go.microsoft.com/fwlink/?linkid=2080838) (**configurações** > **exibir todas as configurações** > do Outlook**tratamento de mensagens**).