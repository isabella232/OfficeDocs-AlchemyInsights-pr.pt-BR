...
---
# <a name="error-your-new-install-has-newer-features-than-your-current-version-do-you-want-to-activate"></a>Erro: sua nova instalação tem recursos mais novos que a versão atual. Você deseja ativar...

Para corrigir esse erro do Office, escolha a solução automatizada para sua versão do Office:

- Para Microsoft 365, baixe e execute o [Assistente de Recuperação e Suporte](https://aka.ms/SaRA-OfficeActivation-Chat). Siga as instruções e os prompts para solucionar o erro de ativação do Office.
