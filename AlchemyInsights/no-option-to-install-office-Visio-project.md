...
---
# <a name="no-option-to-install-office-visio-or-project"></a>Não há opção para instalar o Office, Visio ou Project
...
1. Vá para a [página do portal](https://portal.office.com/OLS/MySoftware.aspx).

2. Entre com a conta corporativa ou de estudante que tem uma licença do Office atribuída.

3. Na seção Office, selecione o idioma. Escolha a versão de 32 bits ou a versão de 64 bits.
