---
title: 'Erro: Não foi possível verificar sua assinatura. Verifique se você está conectado à Internet.'
ms.author: pebaum
author: pebaum
manager: dansimp
ms.date: 03/16/2021
...
ms.locfileid: "50897451"
---
# <a name="error-we-couldnt-verify-your-subscription-please-make-sure-that-youre-connected-to-the-internet"></a>Erro: Não foi possível verificar sua assinatura. Verifique se você está conectado à Internet.

Para corrigir esse erro do Office, escolha a solução automatizada para sua versão do Office:

- Para Microsoft 365, baixe e execute o [Assistente de Recuperação e Suporte](https://aka.ms/SaRA-OfficeActivation-Chat). Siga as instruções e prompts para solucionar o erro de ativação do Office.
