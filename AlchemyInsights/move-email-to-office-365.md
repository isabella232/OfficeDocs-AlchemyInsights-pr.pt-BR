...
Para ler sobre suas opções sem iniciar a migração, confira [decidir sobre um caminho de migração](https://docs.microsoft.com/en-us/Exchange/mailbox-migration/decide-on-a-migration-path).
