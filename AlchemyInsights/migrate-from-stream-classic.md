...
Para obter mais informações sobre a migração do fluxo clássico para o novo Stream, consulte [Migrate from Microsoft Stream (Classic) to the New Microsoft Stream](https://docs.microsoft.com/stream/classic-migration)