...
Para desabilitar o encaminhamento de email para uma caixa de correio específica, confira [Configurar o encaminhamento de email no Office 365](https://docs.microsoft.com/office365/admin/email/configure-email-forwarding).
