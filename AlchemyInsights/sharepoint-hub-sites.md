...
Consulte [criar um site de Hub no SharePoint Online](https://docs.microsoft.com/sharepoint/create-hub-site) para obter mais informações sobre como criar um site de Hub do novo centro de administração ou do PowerShell.
...
Consulte [remover um site de Hub](https://docs.microsoft.com/sharepoint/remove-hub-site) para obter mais informações sobre como remover um site de Hub existente do novo centro de administração ou do PowerShell.
