...
Os administradores podem cancelar a assinatura do projeto para sua organização a partir do **centro de administração do Microsoft 365**.

1. Vá para a página de **cobrança > [seus produtos](https://go.microsoft.com/fwlink/p/?linkid=842054) ** .

2. Localize o plano de projeto a ser cancelado.
