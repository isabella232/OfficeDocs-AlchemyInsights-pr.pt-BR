---
title: Importar contatos em Outlook.com
ms.author: daeite
author: daeite
manager: joallard
ms.date: 04/21/2020
...
ms.locfileid: "53962191"
---
# <a name="import-contacts"></a>Importar contatos

Antes de importar contatos para Outlook.com, você precisará exportá-los de seu outro provedor de email como um arquivo .csv. Em seguida, siga as instruções abaixo.
...
.
2. Na parte superior da página, selecione **Gerenciar** \> **Importar contatos**.
3. Selecione **Procurar**, navegue até a pasta onde você salvou seus contatos exportados e selecione **Abrir**.

Para saber mais, confira [Importar contatos para Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
