...
1. Se você estiver usando o Outlook 2016, na guia **Página** Base, clique em **Regras**  >  **Gerenciar Regras & Alertas**. 
1. Na guia **Regras de Email,** role a lista e exclua todas as regras que você não reconhece.
1. Se você estiver usando o Outlook na Web, clique em **Configurações** ícone > **Exibir todas as configurações do Outlook.**
