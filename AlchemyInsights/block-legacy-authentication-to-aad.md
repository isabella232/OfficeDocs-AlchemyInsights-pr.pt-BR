...
- [Bloquear o acesso quando um risco de sessão é detectado com o Acesso Condicional do Azure Active Directory](https://docs.microsoft.com/azure/active-directory/conditional-access/app-sign-in-risk)