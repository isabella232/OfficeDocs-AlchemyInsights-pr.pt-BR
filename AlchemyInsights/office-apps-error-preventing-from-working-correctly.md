---
title: 'Erro de aplicativos do Office: o aplicativo foi executado em um erro que o impede de funcionar corretamente'
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "40886431"
---
# <a name="office-apps-error-app-has-run-into-an-error-that-is-preventing-it-from-working-correctly"></a>Erro de aplicativos do Office: o aplicativo foi executado em um erro que o impede de funcionar corretamente
...
**Observação:** Se o problema ocorrer com determinados documentos, esses documentos podem estar corrompidos. Veja [como solucionar problemas de documentos danificados](https://docs.microsoft.com/office/troubleshoot/word/damaged-documents-in-word).

Para saber mais, confira: 

- [Erro ao abrir os aplicativos do Microsoft Office](https://support.office.com/article/error-when-opening-microsoft-office-apps-b84b6a63-4b8c-46ec-ae9a-ad91d6160d72)
...
- [Solucionar problemas que ocorrem quando você inicia ou usa aplicativos do Office](https://docs.microsoft.com/office/troubleshoot/word/issues-when-start-or-use-word)