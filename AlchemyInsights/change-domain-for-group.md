...
Depois que o grupo Microsoft 365 já tiver sido criado, não há uma maneira de alterar o domínio no momento. A única maneira é criar um novo grupo do Microsoft 365 e excluir o antigo, se necessário (endereços de email adicionais podem ser adicionados através do [centro de administração do Exchange](https://outlook.office365.com/ecp.aspx)).