...
Se **os usuários externos** não puderem enviar emails para uma Pasta Pública habilitada para email, o motivo pode ser que a pasta pública está sem permissões necessárias para a entrega de emails externos. Você pode corrigir isso usando as instruções do Outlook [aqui](https://technet.microsoft.com/library/aa997560%28v=exchg.150%29.aspx.aspx#Anchor_1), ou as instruções do PowerShell [aqui](https://support.microsoft.com/help/2984402/-5.7.1-smtp-550-5.7.1-resolver.rst.authrequired-nondelivery-report-when-external-users-try-to-send-mail-to-mail-enabled-public-folders-in-office-365.aspx).
