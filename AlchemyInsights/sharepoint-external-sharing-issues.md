...
ms.locfileid: "54023258"
---
# <a name="external-user-is-unable-to-access-content-in-sharepoint-online"></a>O usuário externo não consegue acessar o conteúdo no SharePoint Online
...
- [Erros de compartilhamento do OSE no Sharepoint e OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
