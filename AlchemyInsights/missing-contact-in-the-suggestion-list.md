...
---
# <a name="missing-contact-in-suggestion-list-while-composing-mail"></a>Contato ausente na lista de sugestões ao redigir email

1. Selecione **para:** e, em seguida, selecione um contato na lista.
2. Selecione **Enviar**.
