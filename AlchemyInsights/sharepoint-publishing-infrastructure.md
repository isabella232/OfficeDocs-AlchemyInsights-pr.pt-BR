...
O SharePoint inclui um conjunto clássico de recursos que permitem que você crie e publique páginas da Web sofisticadas para sua intranet. Ative a infraestrutura de publicação do SharePoint no nível do conjunto de sites para ativá-las.
...
- Os recursos de publicação clássica não estão disponíveis em sites modernos. Os sites modernos fornecem uma alternativa mais recente por padrão.
