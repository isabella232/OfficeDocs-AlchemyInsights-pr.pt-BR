...
---
# <a name="create-an-allow-list-of-endpoints-for-microsoft-edge"></a>Criar uma lista de permissões de pontos de extremidade para o Microsoft Edge

Para ter a matriz completa dos recursos do Microsoft Edge à sua disposição, você deve estar conectado à Internet. Além disso, para permitir que o navegador se comunique por meio de firewalls e outros mecanismos de segurança na Internet, você deve adicionar um conjunto de URLs de domínio à sua [lista de permissões de pontos de extremidade](https://go.microsoft.com/fwlink/?linkid=2135054).
