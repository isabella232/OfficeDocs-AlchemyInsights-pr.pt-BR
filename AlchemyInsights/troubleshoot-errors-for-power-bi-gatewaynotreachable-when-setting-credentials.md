...
Você pode encontrar GatewayNotReachable ao tentar definir credenciais para uma fonte de dados no serviço do Power BI. Isso pode ser resultado de um gateway desatualizado. Instale o gateway mais recente e tente novamente.
