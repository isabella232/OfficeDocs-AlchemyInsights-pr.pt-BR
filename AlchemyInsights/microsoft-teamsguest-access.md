...
Precisa de ajuda para ativar e configurar o recurso de acesso de convidados no Microsoft Teams?  

Primeiro, verifique se você seguiu todas as etapas na lista de [verificação de acesso de convidados](https://docs.microsoft.com/en-us/microsoftteams/guest-access-checklist). Após a conclusão de todas as etapas, você precisa [aguardar até 24 horas](https://docs.microsoft.com/en-us/microsoftteams/manage-guests#guest-access-latencies) para que as configurações entrem em vigor.
