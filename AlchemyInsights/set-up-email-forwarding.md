...
> Se esta for uma caixa de correio de usuário, vá para usuários **ativos** do **usuários** \> e selecione o usuário cuja caixa de correio você está encaminhando. Na guia **email** , selecione **gerenciar encaminhamento de email**.
...
Para obter mais informações, consulte [Configurar o encaminhamento de email no Office 365](https://docs.microsoft.com/office365/admin/email/configure-email-forwarding).
...
Você tem um funcionário saindo? Confira [remover um antigo funcionário do Office 365](https://docs.microsoft.com/office365/admin/add-users/remove-former-employee) para ver as etapas recomendadas.