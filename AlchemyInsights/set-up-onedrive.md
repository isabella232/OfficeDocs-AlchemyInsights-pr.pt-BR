...
---
# <a name="use-the-onedrive-syn-client-to-sync-onedrive-or-sharepoint-files"></a>Usar o cliente SYN do OneDrive para sincronizar arquivos do OneDrive ou do SharePoint
