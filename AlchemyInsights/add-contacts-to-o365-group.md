...
Você também pode adicionar ou remover membros do grupo no Portal de Administração: Adicionar ou remover membros de grupos Microsoft 365 [usando o Centro de administração do Microsoft 365](/microsoft-365/admin/create-groups/add-or-remove-members-from-groups)