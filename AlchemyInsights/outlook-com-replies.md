...
**Configurações**  >  do **Exibir todas as configurações**  >  do Outlook **Email**  >  **Respostas automáticas** para abrir suas [configurações de respostas automáticas](https://outlook.live.com/mail/options/mail/automaticReplies).
