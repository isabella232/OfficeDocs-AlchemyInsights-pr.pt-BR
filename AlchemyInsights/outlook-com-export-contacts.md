...
---
# <a name="export-your-contacts-in-outlookcom"></a>Exportar seus contatos no Outlook.com
...
.
2. Na parte superior da página, selecione **gerenciar** \> **exportação**.
3. Escolha se você deseja exportar todos os contatos ou somente contatos de uma pasta específica e selecione **Exportar**.
