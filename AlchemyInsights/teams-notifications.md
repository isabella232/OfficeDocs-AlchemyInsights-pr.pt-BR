...
No aplicativo de área de trabalho do Teams, há várias maneiras de acessar e gerenciar as notificações. Para personalizar ainda mais as suas configurações de notificação, selecione a sua imagem de perfil no canto superior direito das equipes e vá para **Configurações > Notificações de Atividades**. A partir daí, você pode ajustar quais notificações receberá e onde essas notificações aparecem. 

Em aplicativos iOS e Android, toque em **Mais > Configurações > Notificações** para personalizar suas notificações.

Para saber mais, confira [Seis coisas que você precisa saber sobre as notificações](https://support.microsoft.com/pt-BR/office/six-things-to-know-about-notifications-abb62c60-3d15-4968-b86a-42fea9c22cf4) e [Gerenciar notificações no Teams](https://support.office.com/article/manage-notifications-in-teams-1cc31834-5fe5-412b-8edb-43fecc78413d#ID0EAABAAA).
