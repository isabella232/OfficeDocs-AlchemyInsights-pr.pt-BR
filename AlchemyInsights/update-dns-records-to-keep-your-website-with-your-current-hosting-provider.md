...
Para saber mais, confira [atualizar registros DNS para manter seu site com seu provedor de hospedagem atual](https://docs.microsoft.com/office365/admin/dns/update-dns-records-to-retain-current-hosting-provider).
  
Para saber mais sobre a descontinuação de site público, confira [sites públicos do SharePoint Online que serão descontinuados](https://support.office.com/article/sharepoint-online-public-websites-to-be-discontinued-e86bfd2f-5c7d-446f-a430-7cfcc0130916).
