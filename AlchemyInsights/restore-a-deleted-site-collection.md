...
Quando um administrador exclui um site do SharePoint, ele é colocado na lixeira do conjunto de sites, onde é mantido por 93 dias antes de ser excluído permanentemente. Para restaurar o site:
  
1. No novo centro de administração do SharePoint, clique em **Lixeira** na faixa de opções. 
